/**
 * Pre-resolved tokens for delta-vision-60s.
 * Same as autarqui-co.visual-style.md (canonical brand).
 */
...
export const TOKENS: StyleTokens = {
  ...
  layout: {
    hero: { font_size_px: 96, line_height: 1.12, letter_spacing_em: -0.02, alignment: "flush-left", max_width_pct: 92 },
    body: { font_size_px: 28, line_height: 1.55 },
    list_item: { numeral_font_size_px: 38, main_font_size_px: 78, indent_pct: 8 },
    master_quote: { font_size_px: 56, alignment: "center", has_rules: true },
    closing: { logo_size_px: 340, spacing_px: 30 },
  },
  motion: {
  ...
  audio: { music_curve: "editorial", prefer_voice: "piper", voice_language: "es" },
  ios_chrome: false,
  forbidden: ["gradients", "glassmorphism", "drop shadows", "rounded card stacks", "emoji", "exclamation marks"],
  verbatim_lines: { master: "autarqui.co hace empresas más autosuficientes." },
};
