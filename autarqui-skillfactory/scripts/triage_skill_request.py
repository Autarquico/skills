...
Part of the autarqui-skillfactory skill (Phase 0: Skill Triage).
...
def format_output(result: Result) -> str:
    ...
    if action == Action.USE_EXISTING:
        ...
        lines.append(f"  Command: Autarqui SkillFactory: improve {target}")
        ...
        lines.append(f"  Command: Autarqui SkillFactory: create a skill for {purpose}")
