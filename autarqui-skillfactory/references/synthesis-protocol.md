...
### Autarqui SkillFactory's Choice

Autarqui SkillFactory uses **shared context** (no `context: fork`) because:
...
Skills created BY Autarqui SkillFactory may choose either approach based on their needs.
