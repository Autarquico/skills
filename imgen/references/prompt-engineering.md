...
### Restraint anchors (preferred for minimal / editorial brand work)

When the brief calls for Apple-like restraint or monochrome editorial calm
(common for minimal brand systems), prefer these anchors over loud editorial
ones:
- "Apple Newsroom product photography, neutral seamless backdrop"
- "Stripe Press book cover, matte paper, generous negative space"
- "Kinfolk magazine still life, natural window light"
- "Cereal magazine editorial, muted palette"
- "MoMA design collection catalogue plate"
- "Dieter Rams product study, Braun archive lighting"
- "Massimo Vignelli grid system, Unimark archive print"

These pair well with brands whose `brand.yml` lists them in `positive_anchors`.

### Tonal blacklist for restrained / minimal work

In addition to the global banned keywords above, AVOID these for any minimal
or restraint-driven brief unless the user explicitly asks for them:
- "vibrant", "colorful", "saturated", "vivid"
- "glossy", "shiny", "chrome", "metallic sheen", "iridescent", "holographic"
- "dramatic lighting", "cinematic lighting" (use "soft natural light" instead)
- "gradient", "glow", "neon", "lens flare", "bokeh background"
- "futuristic", "sci-fi", "cyberpunk"
- "HUD", "digital grid", "circuit board", "glowing data", "AI brain", "robot hand"
- "glassmorphism", "3D bevel", "drop shadow", "long shadow"
- "trendy", "instagram-style", "viral"

### Restraint anchors -- positive vocabulary

Reach for: "monochrome", "matte", "paper-like", "museum-grade", "editorial",
"calm", "restrained", "rigorous grid", "generous negative space",
"single focal point", "soft directional window light", "overcast diffusion",
"natural materials", "linen", "ceramic", "raw concrete", "brushed steel",
"hand-bound book", "archival print".
